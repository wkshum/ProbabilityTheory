...
- p.14. In Example 1.3.2, the function $\alpha_2(x)$ for $x$ between $-1.5$ to $1.5$ is defined as $\int_{-\infty}^x e^{-t^2/2}/\sqrt{2\pi}\, dt$, which is the same as the cumulative distribution function of a standard normal random variable.
